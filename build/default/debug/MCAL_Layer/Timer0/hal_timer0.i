...
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../mcal_std_types.h" 1
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 14 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 15 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../std_libraries.h" 2
# 31 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../compiler.h" 1
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../compiler.h"
...
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../compiler.h" 2
# 14 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 34 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 50 "MCAL_Layer/Timer0/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 58 "MCAL_Layer/Timer0/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 13 "MCAL_Layer/Timer0/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h" 2
...
# 96 "MCAL_Layer/Timer0/hal_timer0.h"
...
# 113 "MCAL_Layer/Timer0/hal_timer0.h"
Std_ReturnType Timer0_Write_value(const timer0_t *timer0 , uint16 value);
# 122 "MCAL_Layer/Timer0/hal_timer0.h"
...
# 28 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_Init(const timer0_t *timer0){
...
# 63 "MCAL_Layer/Timer0/hal_timer0.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 81 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_DeInit(const timer0_t *timer0){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if(((void*)0) == timer0){
        retVal = (Std_ReturnType)0x00;
...
# 106 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_Write_value(const timer0_t *timer0 , uint16 value){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if(((void*)0) == timer0){
        retVal = (Std_ReturnType)0x00;
...
# 127 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_Read_value(const timer0_t *timer0 , uint16 *value){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
...
static __attribute__((inline)) void Timer0_Mode_Select(const timer0_t *timer0){
    if(((void*)0) != timer0){
        if(1 == timer0->timer0_mode){
            ...
            (T0CONbits.T0CS = 1);
            if(0 == timer0->timer0_counter_edge){
                (T0CONbits.T0SE = 0);
            }
            else if(1 == timer0->timer0_counter_edge){
                (T0CONbits.T0SE = 1);
            }
        }
    }
...
static __attribute__((inline)) void Timer0_Register_Size_Config(const timer0_t *timer0){
    if(((void*)0) != timer0){
        ...
        else if(0 == timer0->timer0_register_size){
            (T0CONbits.T08BIT = 0);
        }
    }
}

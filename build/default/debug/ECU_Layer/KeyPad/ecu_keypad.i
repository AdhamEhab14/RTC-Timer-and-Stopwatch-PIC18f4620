...
# 31 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 50 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 95 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 115 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_write_logic(const pin_config_t * config , logic_t logic_status);
# 125 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_read_logic(const pin_config_t * config , logic_t *logic_status);
# 134 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t * config);
# 143 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_initialize(const pin_config_t * config);
# 155 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_direction_initialize(port_index_t port, uint8 direction);
# 165 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status);
# 175 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_write_logic(port_index_t port, uint8 logic);
# 185 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic);
# 194 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
...
Std_ReturnType keypad_get_value(const keypad_t * pad , uint8 * value){
    ...
    if((((void*)0) == pad) || (((void*)0) == value)){
        ...
        for(rows_counter=0 ; rows_counter < 4 ; rows_counter++){
            ...
            _delay((unsigned long)((70)*(8000000UL/4000.0)));
            for(columns_counter=0; columns_counter < 4 ; columns_counter++){

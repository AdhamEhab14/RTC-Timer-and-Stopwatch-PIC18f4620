...
# 31 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 34 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 50 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 95 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t * config);
# 105 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t * config , direction_t * direcion_status);
# 115 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_write_logic(const pin_config_t * config , logic_t logic_status);
# 125 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_read_logic(const pin_config_t * config , logic_t *logic_status);
# 134 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t * config);
# 143 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_initialize(const pin_config_t * config);
# 155 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_direction_initialize(port_index_t port, uint8 direction);
# 165 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status);
# 175 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_write_logic(port_index_t port, uint8 logic);
# 185 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
Std_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic);
# 194 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 18 "ECU_Layer/7_Segment/ecu_seven_seg.c"
Std_ReturnType seven_segment_initialize(const segment_t *segment){
    ...
    if(((void*)0) == segment){
        ...
        retVal = gpio_pin_initialize(&(segment->segment_pin[0]));
        retVal = gpio_pin_initialize(&(segment->segment_pin[1]));
        retVal = gpio_pin_initialize(&(segment->segment_pin[2]));
        retVal = gpio_pin_initialize(&(segment->segment_pin[3]));
        retVal = (Std_ReturnType)0x01;
    }
    return retVal;
}
# 41 "ECU_Layer/7_Segment/ecu_seven_seg.c"
Std_ReturnType seven_segment_write_number(const segment_t *segment , uint8 number){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if((((void*)0) == segment) || (number > 9)){
        ...
        retVal = gpio_pin_write_logic(&(segment->segment_pin[0]) , number & 0x01);
        retVal = gpio_pin_write_logic(&(segment->segment_pin[1]) , (number>>1) & 0x01);
        retVal = gpio_pin_write_logic(&(segment->segment_pin[2]) , (number>>2) & 0x01);
        retVal = gpio_pin_write_logic(&(segment->segment_pin[3]) , (number>>3) & 0x01);
        retVal = (Std_ReturnType)0x01;
    }
    return retVal;
}
